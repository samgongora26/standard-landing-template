        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('posts.create')" :active="route().current('posts.create')">
                                    Crear Post
                                </JetNavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <JetResponsiveNavLink :href="route('tours')" :active="route().current('tours')">
                            Tours
                        </JetResponsiveNavLink>
                        <JetResponsiveNavLink :href="route('servicies')" :active="route().current('servicies')">
                            Servicies
                        </JetResponsiveNavLink>
                        <JetNavLink :href="route('posts.create')" :active="route().current('posts.create')">
                            Crear Post
            ...
            <main>
                <div v-if="$page.props.flash.status"  
                    class="flex p-4 mb-4 bg-blue-100 rounded-lg" role="alert">
                    ...
                    <button
                        @click="$page.props.flash.status = false"
                        type="button" class="ml-auto -mx-1.5 -my-1.5 bg-blue-100 text-blue-500 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5 hover:bg-blue-200 inline-flex h-8 w-8" data-dismiss-target="#alert-2" aria-label="Close">
                ...
                <div v-if="$page.props.flash.errors"  
                    class="flex p-4 mb-4 bg-red-100 rounded-lg " role="alert">
                    ...
                    <div v-for="error in $page.props.flash.errors.default" :key="error[0]" class="ml-3 text-sm font-medium text-red-700 dark:text-red-800">
                        - {{ error[0] }}
                    </div>
                    <button
                        @click="$page.props.flash.errors = false"
